...
impl<'a, 'tcx> InferCtxtExt<'tcx> for InferCtxt<'a, 'tcx> {
    fn impl_similar_to(
        ...
        self.tcx.for_each_relevant_impl(trait_ref.def_id, trait_self_ty, |def_id| {
            let impl_substs = self.fresh_substs_for_item(obligation.cause.span_source, def_id);
    ...
    fn on_unimplemented_note(
        ...
        if let Some(k) = obligation.cause.span_source.to_span(self.tcx).desugaring_kind() {
